...
func (_Token *TokenTransactor) Deposit(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "deposit")
}
...
func (_Token *TokenSession) Deposit() (*types.Transaction, error) {
	return _Token.Contract.Deposit(&_Token.TransactOpts)
}
...
func (_Token *TokenTransactor) WithdrawToken(opts *bind.TransactOpts, token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "withdrawToken", token, account, amount)
}

// WithdrawToken is a paid mutator transaction binding the contract method 0x01e33667.
//
// Solidity: function withdrawToken(address token, address account, uint256 amount) returns()
func (_Token *TokenSession) WithdrawToken(token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.WithdrawToken(&_Token.TransactOpts, token, account, amount)
}

// WithdrawToken is a paid mutator transaction binding the contract method 0x01e33667.
//
// Solidity: function withdrawToken(address token, address account, uint256 amount) returns()
func (_Token *TokenTransactorSession) WithdrawToken(token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.WithdrawToken(&_Token.TransactOpts, token, account, amount)
}
